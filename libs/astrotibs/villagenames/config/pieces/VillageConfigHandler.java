...
public class VillageConfigHandler
{
	...
	{
		village_prefix = config.getString("Prefixes", Reference.CATEGORY_VILLAGE_SYLLABLE_POOL, NamePieces.village_prefix_default,
				"Prefixes that can occur before the core name.").trim().split("\\s*,\\s*");
		
		village_root_initial = config.getString("Root: Initial", Reference.CATEGORY_VILLAGE_SYLLABLE_POOL, NamePieces.village_root_initial_default,
				"Core names begin with one of these half-syllables. Use _ to represent a space.").trim().split("\\s*,\\s*");
		
		village_root_syllables = config.getString("Root: Syllables", Reference.CATEGORY_VILLAGE_SYLLABLE_POOL, NamePieces.village_root_sylBegin_default,
		...
		village_root_terminal = config.getString("Root: Terminal", Reference.CATEGORY_VILLAGE_SYLLABLE_POOL, NamePieces.village_root_terminal_default,
		...
		syllable_count_weighting = config.get(Reference.CATEGORY_VILLAGE_SYLLABLE_POOL, "Syllable Count Weighting", NamePieces.village_syllable_count_weights,
		...
		prefix_chance = config.getFloat("Prefix Chance", Reference.CATEGORY_VILLAGE_SYLLABLE_POOL,
		...
		suffix_chance = config.getFloat("Suffix Chance", Reference.CATEGORY_VILLAGE_SYLLABLE_POOL,
