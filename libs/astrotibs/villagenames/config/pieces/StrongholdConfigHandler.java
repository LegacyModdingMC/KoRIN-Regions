...
public class StrongholdConfigHandler
{
	...
	{
		stronghold_prefix = config.getString("Prefixes", Reference.CATEGORY_STRONGHOLD_SYLLABLE_POOL, NamePieces.stronghold_prefix_default,
				"Prefixes that can occur before the core name.").trim().split("\\s*,\\s*");
		
		stronghold_root_initial = config.getString("Root: Initial", Reference.CATEGORY_STRONGHOLD_SYLLABLE_POOL, NamePieces.stronghold_root_initial_default,
				"Core names begin with one of these half-syllables. Use _ to represent a space.").trim().split("\\s*,\\s*");
		
		stronghold_root_syllables = config.getString("Root: Syllables", Reference.CATEGORY_STRONGHOLD_SYLLABLE_POOL, NamePieces.stronghold_root_sylBegin_default,
		...
		stronghold_root_terminal = config.getString("Root: Terminal", Reference.CATEGORY_STRONGHOLD_SYLLABLE_POOL, NamePieces.stronghold_root_terminal_default,
		...
		syllable_count_weighting = config.get(Reference.CATEGORY_STRONGHOLD_SYLLABLE_POOL, "Syllable Count Weighting", NamePieces.stronghold_syllable_count_weights,
		...
		prefix_chance = config.getFloat("Prefix Chance", Reference.CATEGORY_STRONGHOLD_SYLLABLE_POOL,
		...
		suffix_chance = config.getFloat("Suffix Chance", Reference.CATEGORY_STRONGHOLD_SYLLABLE_POOL,
