...
public class RuneStoneGUI extends GuiContainer {
  ...
  public void initGui() {
    ...
    if (!strlist.isEmpty()) {
      ...
      for (int i = 0; i < n; i++) {
        ...
        this.buttonList.add(new RINButtonRunestone(i, (int)(k + x - 8.0F), (int)(l + z - 8.0F), I18n.format(strlist.get(i), new Object[0])));
      } 
    } 
    super.initGui();
  }
  ...
  protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
    ...
    this.mc.getTextureManager().bindTexture(new ResourceLocation("korinregions:textures/gui/gui_runestone_1.png"));
