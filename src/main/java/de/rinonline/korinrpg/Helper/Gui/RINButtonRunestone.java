    ...
    public void drawButton(Minecraft minecraft, int xCoord, int yCoord) {
        if (this.visible) {
            ...
            minecraft.getTextureManager()
                .bindTexture(this.buttonTexture);
            this.field_146123_n = (xCoord >= this.xPosition && yCoord >= this.yPosition
                && xCoord < this.xPosition + this.width
                && yCoord < this.yPosition + this.height);
