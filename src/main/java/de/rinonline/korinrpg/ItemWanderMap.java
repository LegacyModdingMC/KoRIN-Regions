...
public class ItemWanderMap extends Item {
  ...
  public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
    if (!p_77659_2_.isRemote) {
      PacketDispatcher.sendTo((IMessage)new SyncPlayerPropsMessage(p_77659_3_), (EntityPlayerMP)p_77659_3_);
      p_77659_3_.openGui(RINMAIN.instance, 55, p_77659_3_.worldObj, (int)p_77659_3_.posX, (int)p_77659_3_.posY, (int)p_77659_3_.posZ);
    } 
    return p_77659_1_;
  }
}
