...
public class FortressConfigHandler
{
	...
	{
		fortress_prefix = config.getString("Prefixes", Reference.CATEGORY_FORTRESS_SYLLABLE_POOL, NamePieces.fortress_prefix_default,
				"Prefixes that can occur before the core name.").trim().split("\\s*,\\s*");
		
		fortress_root_initial = config.getString("Root: Initial", Reference.CATEGORY_FORTRESS_SYLLABLE_POOL, NamePieces.fortress_root_initial_default,
				"Core names begin with one of these half-syllables. Use _ to represent a space.").trim().split("\\s*,\\s*");
		
		fortress_root_syllables = config.getString("Root: Syllables", Reference.CATEGORY_FORTRESS_SYLLABLE_POOL, NamePieces.fortress_root_sylBegin_default,
		...
		fortress_root_terminal = config.getString("Root: Terminal", Reference.CATEGORY_FORTRESS_SYLLABLE_POOL, NamePieces.fortress_root_terminal_default,
		...
		syllable_count_weighting = config.get(Reference.CATEGORY_FORTRESS_SYLLABLE_POOL, "Syllable Count Weighting", NamePieces.fortress_syllable_count_weights,
		...
		prefix_chance = config.getFloat("Prefix Chance", Reference.CATEGORY_FORTRESS_SYLLABLE_POOL,
		...
		suffix_chance = config.getFloat("Suffix Chance", Reference.CATEGORY_FORTRESS_SYLLABLE_POOL,
